              ...
              <v-flex xs5 > 
                <v-card>
                  ...
                  <v-list dense>
                    ...
                    <v-list-tile>
                      <v-list-tile-content class="font-weight-bold">Latitude:</v-list-tile-content>
                      <v-list-tile-content class="align-end">{{ item.latitude }}</v-list-tile-content>
                    </v-list-tile>

                    <v-list-tile>
                      <v-list-tile-content class="font-weight-bold">Longitude:</v-list-tile-content>
                      <v-list-tile-content class="align-end">{{ item.longitude }}</v-list-tile-content>
                    </v-list-tile>
              ...
              <v-flex xs7>
                <v-card  class="commentClass scroll" height="100">
                  ...
                  <v-list two-line>
                    ...
                    <!-- <v-list-tile v-for="comment in comments" :key="comment" >
                      <v-list-tile-content class="font-weight-bold">{{ comment.user.username }}</v-list-tile-content>
                      <v-list-tile-content class="font-weight-bold">Comment:</v-list-tile-content>
                      <v-list-tile-content class="align-end ">{{ comment.comment }}</v-list-tile-content>
                    </v-list-tile> -->
                  </v-list>
                </v-card>
